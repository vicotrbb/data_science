...
plt.clf()
matrix_corrlation = boston.corr().round(2)
sns.heatmap(data=matrix_corrlation, annot=True)
plt.show()

# Na Matriz de correlacao, quanto mais escuro o quadrado maior a correlacao, seja ela negativa ou positiva. Essa correlacao vai
# de -1 a 1, quanto mais perto de 1, mais forte a correlacao positiva dos atributos e quanto mais proxima de -1, maior a correlacao
# negativa dos atributos
